...
uint256 hashGenesisBlock("0x7fbc86b89a73418fe5327bd4edfe787c8e9ba799277d99a27cb0490281c13815");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Zuo: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Zuo Signed Message:\n";
...
{
    // Zuo: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 302400; // Zuo: 3.5 days
static const int64 nTargetSpacing = 150; // Zuo: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Zuo: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Zuo: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Zuo: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6f8d660c024599e350abf355dc9e558304f3df9b39d34bf9005bfff52beafd33");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "India 2017 Another illustrious BR SOFTECH cryptocurrency";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d75695b99e7d20594ec1985bacc766f2d03b11753ea2c920bfb994545bd619f23b9ea4bb1477d3972d35bcbe56489041fc7ea64298439a57039ad6c688fa5c1049") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1511008964;
        block.nBits    = 504365644;
        block.nNonce   = 2048545221;

        if (fTestNet)
        {
            block.nTime    = 1511008964;
            block.nNonce   = 243455944;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2f79efb0607ba242f57e7d0bff71ae30d9772b6230e440b789f509067577e89d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Zuo: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ZuoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ZuoMiner : ProcessBlock, block not accepted");
    }
